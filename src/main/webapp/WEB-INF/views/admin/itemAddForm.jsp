		     		...
		     		<div class="card mb-4"> 
						...
						<section>
							...
							<form action="/web/admin/itemAddForm" method="post" class="form_s" id="form_s" onsubmit="return check();">
								...
								<input type="text" id="itemSize" name="itemSize" placeholder="사이즈" onkeyup="size_check()">
								<input type="text" id="itemQty" name="itemQty" placeholder="수량">
...
function check(){
	...
	var itemSizeCheck = /^[A-Z]*$/;
	if (!itemSizeCheck.test($('#itemSize').val())){
		$('#size_check').text("영어 대문자만 입력하세요").show();
		$("#size_check").css("color", "red");
		return false;
	}
	if($("#itemSize").val() != ""){
